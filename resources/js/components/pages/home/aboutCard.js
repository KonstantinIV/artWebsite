    ...
    return (
      ...
      <div class="aboutContainer">
        <div class="aboutImageContainer">
          <img src="img/profile.jpg" class=" aboutImage" alt="..." />
        ...
        <div class="aboutTextAndLinksContainer">
          <div class="aboutTextContainer">
            ...
            <p class="aboutContact">
              <p class="aboutContacGreen">Contact</p>&nbsp; :  &nbsp; &nbsp;  <p>konstantin-r@hotmail.com</p>
            </p>


          </div>
          <div class="aboutLinksContainer">
            <a class="icon-link icon-link-hover aboutLink" style={{ "--bs-icon-link-transform": " translate3d(0, -.125rem, 0)" }} href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.9.1/font/bootstrap-icons.css">
            ...
            <a class="icon-link icon-link-hover aboutLink" style={{ "--bs-icon-link-transform": " translate3d(0, -.125rem, 0)" }} href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.9.1/font/bootstrap-icons.css">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875
                 ...
                 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588
                  6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"/>
              </svg> Twitter
            </a>
            <a class="icon-link icon-link-hover aboutLink" style={{ "--bs-icon-link-transform": " translate3d(0, -.125rem, 0)" }} href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.9.1/font/bootstrap-icons.css">
              <img src="img/icons/artstation.svg" class="bi bi-twitter aboutLinkIcon" alt="..." fill="currentColor" />
